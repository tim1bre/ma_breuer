# first monte-carlo studie, compare performance of methods
# siehe Monte-Carlo 1 in Masterarbeit 
...
def main():
    ...
    y_s = 20 # cm set point
    u_max = 150 # maximale Stellgröße cm**3/s
    kp = 189.743590
    ki = 15
    kd = 0
    ...
    # create disturbances
    duration_dist = 40 # in s
    t_dist1_0 = 100 # start first disturbance in s
    t_dist2_0 = 200 # start second disturbance in s
    ...
    for repeat in range(0, 1):
        ...
        for noise_sel in noise_sigma:
            for deadtime_sel in deadtime:
                ...
                """# fourth object: dtw algo (ohne Abzug von Mittelwert, Ende der Störung wird nicht erkannt, bessere Methode siehe unten)
                ...
                """
                # 8th object: pelt old, mit Annahme von Störungsdauer
